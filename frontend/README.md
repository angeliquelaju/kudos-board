...
Deployed Application (**required**): (https://kudos-board-uc4g.onrender.com/)
...
I think the lab was really helpful because it helped set up with everything that is needed for the labs, especially with using Isomnia to make sure the post, delete, get and more is working well.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
I think if I had more time I would try do the comments feature because I did not hav enough time to do it as I was capstone planning as well.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?
I think it just took more time, I was able to show all the features I had done which was what went well
